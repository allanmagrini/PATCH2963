...
-- Redmine #76210 - Alteração na apuração de ISS Simplificada para adequar à Apuração de ISS de outro municipio
...
-- Rotinas Alteradas: Criação da procedure pkg_apur_iss_out_mun. Alteração da procedure pkg_gera_guia_pgto
--
