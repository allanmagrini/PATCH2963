...
-- Na fase 22 adicionado (or nvl(gt_row_apuracao_icms_st.Vl_Deb_Esp_St,0) > 0) para alterar o tipo para 1 com operações de st
-- Rotina Alterada: pkb_apuracao
--
-- Em 10/02/2021 - Marcos Ferreira
-- Distribuições: 2.9.7 / 2.9.6-2 / 2.9.5-5
-- Redmine #75460: Considerar estado para geração da Guia de ICMS-ST
-- Rotinas Alteradas: pkg_gera_guia_pgto
-- Alteração: Geração da guia agrupado por Estado.
--
-- Em 10/02/2021 - Marcos Ferreira
-- Distribuições: 2.9.7 / 2.9.6-2 / 2.9.5-5
