...
--
-- Em 18/02/2020   - Allan Magrini - 2.9.5-5 / 2.9.6-2 / 2.9.7
-- Redmine #75154  - Erro no registro B440 - valor contabil mais alto do que o esperado
-- Rotina Alterada - pkb_monta_reg_b440, alterado o vl_cont_rt para sum(iin.vl_base_calc)
--
...
--
-- Em 02/02/2021   - Allan Magrini - 2.9.5-4 / 2.9.6-1 / 2.9.7
-- Redmine #75383  - Problemas no Bloco B (DF)
-- Rotina Alterada -  pkb_monta_reg_b020, alterada a ordem dos select para pegar o cod_part da fase 4 com o da fase 5
--                                      incluida validação para o campo vl_mat_terc
--                    pkb_monta_reg_b420, alterado o cursor c_b420 para pegar somente nota de saida
--                    pkb_monta_reg_b440, alterado o vl_cont_rt para sum(nft.vl_base_calc_iss)
--
