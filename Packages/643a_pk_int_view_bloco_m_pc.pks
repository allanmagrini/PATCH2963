...
-------------------------------------------------------------------------------------------------------
--
-- Em 17/02/2021   - Wendel Albino
-- Redmine #76133  - Geração EFD PIS COFINS
-- Rotina Alterada - pkb_inf_adic_dif_pc -> alterado no ponto da fase 7.7 onde tratava cofins, estava chamando a desprocessa de pis.
--                 - Substituida esta chamada (pk_apur_pis.pkb_desprocessar_cons_pis_m200) por esta (pk_apur_cofins.pkb_desproc_cons_cofins_m600)
-- Rotina Alterada - alterada nas procedures abaixo os calculos de qtd de erp,total,sucesso e erro.
--                 - prc_integr_inf_adic_dif_pis    / pkb_integr_contr_pis_difperant  / pkb_contr_pis_dif_per_ant    / pkb_inf_adic_dif_pc  
--                 - prc_integr_inf_adic_dif_cofins / pkb_integr_contr_cof_difperant  / pkb_contr_cofins_dif_per_ant ;
--   
