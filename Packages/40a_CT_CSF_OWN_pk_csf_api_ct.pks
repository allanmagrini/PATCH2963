...
-- Rotina Alterada - pkb_busca_dm_ind_emit => Incluído campo dm_tp_cte
--                 - pkb_vld_inf_doc => Incluída nova validação para CTe do tipo "2-CT-e de Anulacao de Valores"
-- Liberado        - Release_2.9.7, Patch_2.9.6.2 e Patch_2.9.5.5
--
-- Em 11/02/2021   - Karina de Paula
-- Redmine #75186  - Validação indevida - Prestação de Serviço '0' - (CEVA)
-- Rotina Alterada - pkb_integr_ct_vlprest => Alterada a validação dos campos vl_docto_fiscal e vl_prest_serv para gerarem erro de validação de valor "0" somente
--                   quando dm_tp_cte for igual a "1-CT-e de Complemento de Valores"
-- Liberado        - Release_2.9.7, Patch_2.9.6.2 e Patch_2.9.5.5
--
-- Em 28/01/2021   - Karina de Paula
-- Redmine #75607  - Ajustes na rotina de integração do CTe
-- Rotina Alterada - pkb_integr_conhec_transp => Retirado o delete da log_generico_ct e incluído na pkb_excluir_dados_ct. Alterado o tipo de log para INFORMACAO
--                   onde está como ERRO_DE_VALIDACAO sem gerar contador de erro
--                   Retirado um tratamento errado de dm_st_proc e dm_legado
--                 - pkb_excluir_dados_ct     => Incluído o delete da log_generico_ct
-- Liberado        - Release_2.9.7, Patch_2.9.6.2 e Patch_2.9.5.5
--
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------
   ...
   --
   gn_dm_tp_cte          conhec_transp.dm_tp_cte%type := null;
   --
----------------------------------------------------------------------------------------------------------------------------------------------------------------
